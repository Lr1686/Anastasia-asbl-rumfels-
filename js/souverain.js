...
if (self === top) {
    ...
    try {
        ...
        // Navigation failed/blocked by sandboxed iframe
    }
    // Always halt script execution and remain hidden when framed
    throw new Error("Clickjacking attempt blocked: page execution halted inside frame.");
}
