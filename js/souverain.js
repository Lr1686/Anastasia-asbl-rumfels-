...
/* 🛡️ Sentinel: Fail-closed clickjacking protection with try-catch and frameElement check */
try {
    ...
    throw new Error("Clickjacking attempt blocked: framing exception detected.");
}
